...
import com.example.familytree.databinding.ActivityStoryDetailBinding
        ...
        viewModel.story.observe(this) { story ->
            if (story != null) {
                ...
                binding.textType.text = when(story.storyType) {
                    com.example.familytree.data.model.StoryType.FAMILY -> "家族故事"
                    com.example.familytree.data.model.StoryType.HISTORY -> "家族历史"
                    com.example.familytree.data.model.StoryType.BIOGRAPHY -> "人物传记"
                    com.example.familytree.data.model.StoryType.EVENT -> "活动记录"
                }
