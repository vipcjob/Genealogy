package com.fcz.genealogy.ui.familytree.tree
...
import com.fcz.genealogy.databinding.FragmentTreeViewBinding
...
class TreeViewFragment : Fragment() {
    ...
    private fun setupObservers() {
        ...
        viewModel.focusMember.observe(viewLifecycleOwner) { member ->
            if (member != null) {
                ...
                val maleCount = descendants.count { it.gender == com.fcz.genealogy.data.model.Gender.MALE }
                val femaleCount = descendants.count { it.gender == com.fcz.genealogy.data.model.Gender.FEMALE }
    ...
    private fun buildPath(member: com.fcz.genealogy.data.model.FamilyMember): String {
